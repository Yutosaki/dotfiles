return {
  ...
  opts = function(_, opts)
    ...
    opts.scope.highlight = {
      "WinterBlue", "WinterTeal", "WinterPurple",
      "WinterCyan", "WinterNavy", "WinterMint",
    }
    ...
    opts.scope.include.node_type.lua = {
      "chunk", "do_statement", "while_statement", "repeat_statement",
      "if_statement", "then", "else", "elseif",
      "function_definition", "function_declaration", "function", "arguments",
    ...
    opts.scope.include.node_type.dockerfile = {
      ...
      "copy_instruction", "env_instruction", "workdir_instruction",
    }
